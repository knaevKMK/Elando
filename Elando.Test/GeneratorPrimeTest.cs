namespace Elando.Test
{
    ...
    public class GeneratorPrimeTest
    {
        ...
        {
            var primes = NumbersGenerator.GeneratePrimes(validInput);
        ...
        {
            Assert.ThrowsException<OverflowException>(() => NumbersGenerator.GeneratePrimes(inValidInput));
        }
        [TestMethod]
        [DataRow("2")]
        [DataRow("")]
        ...
        {
            Assert.ThrowsException<InvalidCastException>(() => NumbersGenerator.GeneratePrimes((int)inValidInput));
        }
    }
}
